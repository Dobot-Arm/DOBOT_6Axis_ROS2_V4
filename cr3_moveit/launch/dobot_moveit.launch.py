...
def generate_launch_description():
    ...
    # Joint state relay: 从 /joint_states_robot 转发到 /rsp_joint_states，同时桥接到 /joint_states 供 MoveIt
    urdf_path = str(get_package_share_path('dobot_rviz') / f'urdf/cr3_robot.urdf')
    ld.add_action(Node(
        package='dobot_rviz',
