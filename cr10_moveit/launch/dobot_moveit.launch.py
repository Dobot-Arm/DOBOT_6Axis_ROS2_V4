...
def generate_launch_description():
    moveit_config = MoveItConfigsBuilder("cr10_robot", package_name="cr10_moveit").to_moveit_configs()
    ...
    urdf_path = str(get_package_share_path('dobot_rviz') / f'urdf/cr10_robot.urdf')
    ld.add_action(Node(
        package='dobot_rviz',
